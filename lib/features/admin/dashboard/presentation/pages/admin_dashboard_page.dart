...
class AdminDashboardPage extends StatelessWidget {
              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildStatsSection(context, stats, isWide),
                    SizedBox(height: isWide ? AppConstants.spacing2xl : AppConstants.spacingXl),
  ...
  Widget _buildRecentTicketsSection(BuildContext context, List<Map<String, dynamic>> recentTickets) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
        ...
        ListView.separated(
          ...
          itemBuilder: (context, index) => AdminTicketCard(
            ...
            assignedTo: recentTickets[index]['assignedTo'] != null ? recentTickets[index]['assignedTo'] as String : null,
            onTap: () => Navigator.pushNamed(context, '/admin/ticket-detail', arguments: recentTickets[index]),
          ),
        ),
      ],
    );
